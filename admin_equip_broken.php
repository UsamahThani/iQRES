...
<head>
    ...
    <title>Admin Edit <?php echo $equipID ?> Broken Form | iQReS</title>
</head>
        ...
        <main>
            ...
            <div class="contact">
                <div class="contact-list">
                    ...
                    <h2><?php echo $equipID ?> Broken Form</h2>
                    <div class="add_equip">
                        <form action="function_registerBrokenEquipment.php" method="post">
                            <div class="input-container">
                                <input type="text" id="input" required="" autocomplete="off" name="equipID" readonly value="<?php echo $equipID ?>">
                                <label for="input" class="label">Equipment ID <span class="danger">*</span></label>
                                <div class="underline"></div>
                            </div>
                            <div class="input-container">
                                <input type="date" id="purchaseDate" required="" autocomplete="off" name="brokenDate">
                                <label for="purchaseDate" class="label">Broken Date <span class="danger">*</span></label>
                                <div class="underline"></div>
                            </div>
                            <div class="input-container">
                                <textarea id="input" autocomplete="off" name="brokenDetails" rows="4" required></textarea>
                                <label for="input" class="label">Broken Details <span class="danger">*</span></label>
                                <div class="underline"></div>
                            </div>
