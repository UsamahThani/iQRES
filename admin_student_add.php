...
<head>
    ...
    <title>Register Student | iQReS</title>
    <style>
        ...
        <main>
            ...
            <div class="contact">
                <div class="contact-list">
                    ...
                    <div class="add_equip">
                        <form action="function_registerUser.php" method="post" enctype="multipart/form-data">
                            <div class="input-container">
                                <input type="text" id="input" required="" autocomplete="off" name="userID" readonly value="<?php echo GenerateStudentID(); ?>">
                                <label for="input" class="label">Student ID</label>
                                <div class="underline"></div>
                            </div>
                            <div class="input-container">
                                <input type="text" id="input" required="" autocomplete="off" name="userName">
                                <label for="input" class="label">Full Name</label>
                                <div class="underline"></div>
                            </div> 
                            <div class="input-container">
                                <input type="password" id="input" required="" autocomplete="off" name="userPass">
                                <label for="input" class="label">Password</label>
                                <div class="underline"></div>
                            </div> 
                            <div class="input-container">
                                <input type="file" id="file input" required="" autocomplete="off" name="userImg">
